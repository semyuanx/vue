                  ...
                  <div class="actor-list">
                      <div class="subject">
                          <div class="mainpic">
                              <a href="https://movie.douban.com/subject/25900945/photos?type=R">
                                <img class="movieImg" :src="movieDetail.images.medium" alt="">
                              </a>
                          </div>
                          <div class="info">
                              <span class="p1">导演：</span>
                              <span v-for="item in movieDetail.directors"  :key="item.id" class="attrs">
                                  {{item.name}}
                              </span><br>
                              <span class="p1">主演：</span>
                              <span v-for="item in movieDetail.casts" :key="item.id" class="attrs">
                                  {{item.name}}
                              </span><br>
                               <span class="p1">类型: </span>
                               <span v-for="(item,keys) in movieDetail.genres" :key="keys" class="attrs">
                                   {{item}}/</span><br>
                                <span class="p1">制片国家/地区: </span>
                                <span v-for="item in movieDetail.countries" :key="item" class="attrs">
                                    {{item}}</span><br>
                      ...
                      <div class="people-sroce">
                          <div>
                              ...
                              <el-rate
                               v-model="movieDetail.rating.average" disabled></el-rate>
...
<script>
import movieComment from './moviesComment.vue';
export default {
  name: "moviesDetail",
  mounted() {
